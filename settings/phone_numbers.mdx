...
<Tabs>
  <Tab title="Adding Number">

<Info>We only support USA numbers</Info>

<Frame>
  <img src="/images/settings/numbers.png" />
</Frame>
...
<Frame>
  <img src="/images/settings/twilio_numbers.png" />
    ...
    3. **Complete the Import**
        - After entering your credentials, click **Import from Twilio**. Your Twilio number will now be added, ready for immediate use.

    Your phone number is now set up and ready to be used by your AI agent. You can start making and receiving calls through dashboard.
  </Tab>
</Tabs>
